...
/*                                      NVIC registers                                    */
/* ====================================================================================== */
#define INTERRUPT_ST_CTRL   	           (*((volatile uint32 *)0xE000E010)) 
#define INTERRUPT_ST_RELOAD   	         (*((volatile uint32 *)0xE000E014))
#define INTERRUPT_ST_CURRENT   	         (*((volatile uint32 *)0xE000E018))
