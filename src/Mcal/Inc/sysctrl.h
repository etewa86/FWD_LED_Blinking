...
/**
 *  \name  NVICInterruptEnable
 *
 *  \brief Enable Interrupt for a specified module
 *
 *  \param index  is the vector number of the interrupt
 *         index value is chosen from the g_ISRVirIdx_t enum
 *  \param priority is the interrupt priority ( from 0 to 7)
 *         0 is the highest priority
 *  \param pending if :
 *                    -#TRUE  :the interrupt is set to pending
 *                    -#FALSE :the interrupt is set with no pending
 *
 *  \retval system control error form the enum sSysCtrlError_t
 * */
sSysCtrlError_t NVICInterruptEnable(g_ISRVirIdx_t index,uint8 priority,uint8 pending);

/**
 * \name  NVICInterruptDisable
 *
 * \brief Disable Interrupt for a specified module
 * \param index  is the vector number of the interrupt
 *         index value is chosen from the g_ISRVirIdx_t enum
 *
 * \retval system control error form the enum sSysCtrlError_t
...
/**
 * \name  NVICInterruptClearPending
 *
 * \brief Clears interrupt pending.
 *
 * \param index  is the vector number of the interrupt
 *         index value is chosen from the g_ISRVirIdx_t enum
 *
...
/**
 * \name  NVICInterruptActive
 *
 * \brief Get the active interrupt.
 *
 * \param index  pointer of type g_ISRVirIdx_t enum that holds
 *               the value of the active interrupt index
 *
 * \retval system control error form the enum sSysCtrlError_t
 */
